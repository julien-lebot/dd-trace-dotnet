        ...
        internal Span(SpanContext context, DateTimeOffset? start, ITags tags)
        {
            ...
            if (IsLogLevelDebugEnabled)
            {
                ...
                Log.Debug(
                    ...
                    new object[] { _context.RawSpanId, _context.ParentId, _context.RawTraceId, Tags, tagsType });
            }
        }
            ...
            if (Interlocked.CompareExchange(ref _isFinished, 1, 0) == 0)
            {
                ...
                if (IsLogLevelDebugEnabled)
                {
                    Log.Debug(
                        ...
                        new object[] { _context.RawSpanId, _context.ParentId, _context.RawTraceId, ServiceName, ResourceName, OperationName, Tags });
                }
            }
        }
