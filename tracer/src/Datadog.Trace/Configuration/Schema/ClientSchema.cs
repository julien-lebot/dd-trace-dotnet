...
namespace Datadog.Trace.Configuration.Schema
{
    internal class ClientSchema
    {
        ...
        public ClientSchema(SchemaVersion version, bool peerServiceTagsEnabled, IDictionary<string, string> peerServiceMappings, bool removeClientServiceNamesEnabled, string defaultServiceName, IDictionary<string, string>? serviceNameMappings)
        {
            _version = version;
        ...
        public HttpTags CreateHttpTags()
            => _version switch
            {
                ...
                _ => new HttpV1Tags(_peerServiceMappings),
            };
        ...
        public GrpcClientTags CreateGrpcClientTags()
            => _version switch
            {
                ...
                _ => new GrpcClientV1Tags(_peerServiceMappings),
            };
    }
}
